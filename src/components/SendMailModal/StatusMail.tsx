...
import { IFormProps } from './SendMailModal';
...
interface IStatusContentProps {
    message: string;
    onClose?: () => void;
    sendWhatsapp?: (data: IFormProps) => void;
    data?: IFormProps;
}
...
const ErrorStatus = ({message, onClose, sendWhatsapp=()=>{}, data}:IStatusContentProps) => {
    return (
        <StatusContainer>
            <div className='error'>
            ...
            <button onClick={onClose} className="close">
                ...
                <button onClick={()=>sendWhatsapp(data as IFormProps)} className="whatsapp">
...
const SuccessStatus = ({message, onClose=()=>{}}:IStatusContentProps) => {
    return (
        <StatusContainer>
...
export const StatusMail = ({status, message, formData}:IStatusMailProps) => {
    ...
    const {onSendWhatsAppMessage, onCancelSendEmail}= useContext(GeneralContext)
    switch (status) {
        case "loading":
        ...
        case "error":
            ...
            sendWhatsapp={()=>onSendWhatsAppMessage(formData)} />
        case "success":
